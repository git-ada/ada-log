 ...
 *
 */
public abstract class CopyOfAbstractPageEventHandle implements PageEventHandle{
	...
	public CopyOfAbstractPageEventHandle(Integer[] pageEventThresholds,String eventKey) {
		super();
